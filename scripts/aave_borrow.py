...
def main():
    ...
    # Approve sending out erc20token
    approve_erc20(amount, lending_pool.address, erc20_address, account)
    tx = lending_pool.deposit(erc20_address, amount, account.address, 0, {"from": account})
    tx.wait(1)
    print("Deposited!")
    # ...how much? state of account
...
def get_borrowable_data(lending_pool, account):
    ...
    total_debt_eth, available_borrow_eth, 
...
def approve_erc20(amount, spender, erc20_adddress, account):
    print("approving erc20 token....")
    erc20 = interface.IERC20(erc20_adddress)
